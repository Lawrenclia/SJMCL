...
const IntelligenceSettingsPage = () => {
  ...
  const [port, setPort] = useState(intelligence.mcpServer.launcher.port);

  useEffect(() => {
    setPort(intelligence.mcpServer.launcher.port);
  }, [intelligence.mcpServer.launcher.port]);
  ...
  const mcpServerGroup: OptionItemGroupProps = {
    ...
    items: [
      {
        ...
        children: (
          <Switch
            colorScheme={primaryColor}
            isChecked={intelligence.mcpServer.launcher.enabled}
            onChange={(event) =>
              update(
        ...
        ? [
            {
              ...
              children: (
                <CommonIconButton
                  ...
                  onClick={() =>
                    openUrl(
                      t("IntelligenceSettingsPage.mcpServer.settings.docs.url")
                    )
                  }
                />
              ),
            },
            {
              ...
              children: (
                <NumberInput
                  ...
                  value={port}
                  onChange={(value) => {
                    if (/^\d*$/.test(value)) setPort(Number(value));
                  }}
                  onBlur={() => {
  ...
  return (
    <>
      ...
      <OptionItemGroup {...mcpServerGroup} />
